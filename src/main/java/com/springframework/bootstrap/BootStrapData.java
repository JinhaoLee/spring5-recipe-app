...
import com.springframework.models.*;
...
//    }
    ...
    private List<Recipe> getRecipes() {
        ...
        Optional<UnitOfMeasure> teaSpoonUomOptional = unitOfMeasureRepository.findByDescription(
                "Teaspoon");
        ...
        guacRecipe.setDirections("1 Cut avocado, remove flesh: Cut the avocados in half. Remove " +
                "seed. Score the inside of the avocado with a blunt knife and scoop out the flesh" +
                " with a spoon" +
                "\n" +
        ...
        guacNotes.setRecipeNotes("For a very quick guacamole just take a 1/4 cup of salsa and mix" +
                " it in with your mashed avocados.\n" +
                ...
                "The simplest version of guacamole is just mashed avocados with salt. Don't let " +
                "the lack of availability of other ingredients stop you from making guacamole.\n" +
                "To extend a limited supply of avocados, add either sour cream or cottage cheese " +
        ...
        guacRecipe.addIngredient(new Ingredient("fresh lime juice or lemon juice",
        ...
        tacoNotes.setRecipeNotes("We have a family motto and it is this: Everything goes better " +
                "in a tortilla.\n" +
                "Any and every kind of leftover can go inside a warm tortilla, usually with a " +
                "healthy dose of pickled jalapenos. I can always sniff out a late-night snacker " +
                "when the aroma of tortillas heating in a hot pan on the stove comes wafting " +
                "through the house.\n" +
                ...
                "oregano, cumin, and sweet orange juice while the grill is heating. You can also " +
