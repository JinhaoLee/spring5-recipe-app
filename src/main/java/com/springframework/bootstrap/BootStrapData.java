...
public class BootStrapData implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.setDirections(
                "1 Cut avocado, remove flesh: Cut the avocados in half. Remove "
        ...
        guacNotes.setRecipeNotes(
                "For a very quick guacamole just take a 1/4 cup of salsa and mix"
        ...
        tacoNotes.setRecipeNotes(
                "We have a family motto and it is this: Everything goes better "
                        + "in a tortilla.\n"
